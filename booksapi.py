...
class GoogleBooks():
        ...
        if 'items' in books:
            for k in books['items']:
                values = {"Book Title":"","Authors":"",
                          ...
                          "Page Count":"", "Price":"", "Currency Code":"",
                ...
                try:
                    ...
                    pass
                try:
                    values["Price"] = k['saleInfo']['listPrice']['amount']
                except:
                    pass
                try:
                    values["Currency Code"] = k['saleInfo']['listPrice']['currencyCode']
                except:
                    pass
                try:
    ...
    def write_to_csv(self, new_books, file):
        ...
        header = ["Book Title","Authors","Publisher","Published Date",
                  "Page Count","Price","Currency Code","Rating Count","Average Rating"]
        ...
        for k in new_books:
            ...
            price= k["Price"]
            currency_code = k["Currency Code"]
            rating_count = k["Rating Count"]
            avg_count = k["Average Rating"]
            values = [title, authors, publisher, published_date, page_count, price, currency_code, rating_count, avg_count]
    ...
    def read_from_csv(self, file):
        ...
        try:
            with open(file) as fr:
                logging.info("Reading from file: {}".format(file))
...
def create_parser(args):
    logging.info("Arguments passed: {}".format(args))
